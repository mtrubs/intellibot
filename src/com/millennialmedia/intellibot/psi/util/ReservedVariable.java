...
public enum ReservedVariable {
    ...
    // TODO: EMPTY_LIST('@', "EMPTY", ReservedVariableScope.Global), // Empty list
    // TODO: EMPTY_DICTIONARY('&', "EMPTY", ReservedVariableScope.Global), // Empty dictionary
    ...
    // TODO: NUMBER('$', "80", ReservedVariableScope.Global), // Actual number instead of String value
    PREV_TEST_NAME('$', "PREV_TEST_NAME", ReservedVariableScope.Global), // The name of the previous test case, or an empty string if no tests have been executed yet.
    PREV_TEST_STATUS('$', "PREV_TEST_STATUS", ReservedVariableScope.Global), // The status of the previous test case: either PASS, FAIL, or an empty string when no tests have been executed.
    PREV_TEST_MESSAGE('$', "PREV_TEST_MESSAGE", ReservedVariableScope.Global), // The possible error message of the previous test case.
    ...
    ReservedVariable(char type, @NotNull String variable, @NotNull ReservedVariableScope scope) {
